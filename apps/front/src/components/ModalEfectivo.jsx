...
function ModalEfectivo({
   ...
   return (
    ...
    <div className="bg-white p-6 rounded-lg">
        ...
        <h2 className="text-lg font-semibold mb-4">Valor Total: {totalAmount.toFixed(2)} €</h2>
        <label>Digite valor Efectivo : </label>
        <input type="number"
               value={efectivo} 
               className="text-right w-20"
               onChange={handleChangeEfectivo} /><br/> 
        <h2 className="text-lg font-semibold mb-4">Su cambio: {cambio.toFixed(2)} €</h2>       
